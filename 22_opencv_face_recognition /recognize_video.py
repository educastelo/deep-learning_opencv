# python recognize_video.py -d face_detection_model -m nn4.small2.v1.t7 -r output/recognizer.pickle -l output/le.pickle
...
while True:
    ...
    # apply OpenCV's deep learning-bases face detector to localize
