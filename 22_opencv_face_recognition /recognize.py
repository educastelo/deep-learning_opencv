# python recognize.py -d face_detection_model -m nn4.small2.v1.t7 -r output/recognizer.pickle -l output/le.pickle -i images/dudu.png
...
for i in range(0, detections.shape[2]):
    ...
    if confidence > args["confidence"]:
        ...
        # through our face embedding model to obtain the 123-d
