# python multi_object_tracking_fast.py -p mobilenet_ssd/MobileNetSSD_deploy.prototxt.txt
# -m mobilenet_ssd/MobileNetSSD_deploy.caffemodel -v usain_bolt.mp4 -o usain_bolt_output_fast.avi
