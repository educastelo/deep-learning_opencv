# python track_object.py -p mobilenet_ssd/MobileNetSSD_deploy.prototxt.txt -m mobilenet_ssd/MobileNetSSD_deploy.caffemodel -v input/nascar.mp4 -l car -o output/car_output.avi
